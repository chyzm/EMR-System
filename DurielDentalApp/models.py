...
class DentalExam(models.Model):
    ...
    encounter = models.ForeignKey('core.PatientEncounter', on_delete=models.SET_NULL, null=True, blank=True, related_name='dental_exams')
    chief_complaint = models.TextField(blank=True)
...
class DentalTreatmentPlan(models.Model):
    ...
    encounter = models.ForeignKey('core.PatientEncounter', on_delete=models.SET_NULL, null=True, blank=True, related_name='dental_treatment_plans')
...
class DentalProcedure(models.Model):
    ...
    encounter = models.ForeignKey('core.PatientEncounter', on_delete=models.SET_NULL, null=True, blank=True, related_name='dental_procedures')
...
class DentalMedicalRecord(models.Model):
    ...
    encounter = models.ForeignKey('core.PatientEncounter', on_delete=models.SET_NULL, null=True, blank=True, related_name='dental_records')
