...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['django.core.management.commands.migrate', 'django.core.management.commands.collectstatic', 'core.management.commands.activate_local_clinic', 'core.management.commands.sync_worker', 'waitress'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
