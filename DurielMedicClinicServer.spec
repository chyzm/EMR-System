...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['django.core.management.commands.migrate', 'django.core.management.commands.collectstatic', 'core.management.commands.activate_local_clinic', 'core.management.commands.sync_worker', 'core.management.commands.sync_once', 'core.management.commands.local_update_config', 'waitress'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
